...
from app.models.inventory_item import (InventoryItems, InventoryItemCreate, InventoryItemUpdate)
...
async def read_inventory_item(inventory_item_id: UUID, session: Session = Depends(get_session)):
...
async def update_inventory_item(
    ...
    return update_one(session, InventoryItems, inventory_item_id, update_data.dict(exclude_unset=True))
